 ...
 */
public class ResponsorHost4 extends Messager implements Runnable{
    private int responsorId;

    public ResponsorHost4(int responsorId) {
    ...
    public static void main(String[] args) {
        new Thread(new ResponsorHost4((int) (System.currentTimeMillis()%1000))).start();
    }
}
