...
public class Parameter {
    ...
    public static final String RESPONSE_TAG_CLEAR = "clear_response";
    public static final String REQUEST_TAG_CLEAR= "clear_request";
    ...
    public static final String REQUEST_TAG_SELECT = "select_request";
    public static final String RESPONSE_TAG_SELECT = "select_response";

    public static final String REQUEST_TAG_DROP = "drop_request";
    ...
    public static final String REQUEST_TAG_QUERY_BY_TIME = "query_by_time_request";
    public static final String RESPONSE_TAG_QUERY_BY_TIME = "query_by_time_response";

    public static final String REQUEST_TAG_COURSE_INFO = "course_info_request";
